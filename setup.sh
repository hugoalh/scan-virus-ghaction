...
tar zxf /tmp/powershell-7.2.0-linux-alpine-x64.tar.gz -C /opt/microsoft/powershell/7 -v
rm --force /tmp/powershell-7.2.0-linux-alpine-x64.tar.gz
ln --symbolic /opt/microsoft/powershell/7/pwsh /usr/bin/pwsh
