...
Function Update-GitHubActionScanVirusAssets {
	...
	Try {
		[PSCustomObject]$RemoteMetadata = (Invoke-WebRequest -Uri "$RemoteRoot/raw/main/$MetadataName" -UseBasicParsing -MaximumRedirection 5 -MaximumRetryCount 5 -RetryIntervalSec 5 -Method 'Get' | ConvertFrom-Json -Depth 100)
