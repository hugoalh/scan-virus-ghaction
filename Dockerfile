...
RUN ["pwsh", "-Command", "Add-Content -LiteralPath '/etc/apt/sources.list' -Value @('deb http://deb.debian.org/debian/ bullseye main contrib', 'deb-src http://deb.debian.org/debian/ bullseye main contrib', 'deb http://deb.debian.org/debian/ sid main contrib', 'deb-src http://deb.debian.org/debian/ sid main contrib') -Confirm:\$False -Encoding 'UTF8NoBOM'"]
